  ...
  \mySection{Performance Evaluation}{
    ...
    \mySubSection{Results}{
      ...
      \mySubSubSection{Feature Rankings}{
        Tables \ref{tbl:sfsvmsocial} and \ref{tbl:sfsvmmirex} are the single feature SVM classification accuracies after $10$-fold cross-validation on each of the $154$ features.
      }
      \mySubSubSection{Classification Models}{
        Tables \ref{tbl:svmsocial} and \ref{tbl:svmmirex} are the single feature SVM classification accuracies after $10$-fold cross-validation on each of the $154$ features.
      }
    }

        \begin{table}
          \definecolor{Gray}{gray}{0.85}
          \label{tbl:sfsvmsocial}
          \begin{center}
